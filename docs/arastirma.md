...
- **Kelime havuzu:** Dış listeler ağ kısıtı nedeniyle indirilemediği için 4–7 harfli, özel isim içermeyen, yaygın Türkçe kelimelerden oluşan bir havuz projeye gömüldü. Havuz kolayca genişletilebilir; sözlük kontrolü ayarlardan kapatılabilir.
